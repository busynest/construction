...
export const select = html` 
    ...
    <option value="Carpet layer">Carpet layer</option>
    <option value="Dredger">Dredger</option>
    <option value="Electrician">Electrician</option>
    <option value="Linemen">Linemen</option>
...
export const unitedStates = html `
